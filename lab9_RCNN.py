...
import numpy as np
from Lab8_NMS import non_max_suppression_fast, IOU
from LAB10_ReadPlates import load_data
...
def rcnn(image, model):   # create for prediction
    ...
    cleaned_boxes = non_max_suppression_fast(np.array(positive_boxes),0.1)
    total_boxes = 0
